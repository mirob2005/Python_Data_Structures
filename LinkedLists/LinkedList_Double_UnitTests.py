...
class TestLinkedListDouble(unittest.TestCase):
    ...
    def testInsert(self):
        expResult = "HEAD < (None)<-[1]->(2) (1)<-[2]->(3) (2)<-[3]->(None) > TAIL"
        result = str(self.A)
        self.assertEqual(result, expResult)
        print("\ntestInsert PASSED!")
    ...
    def testAppend(self):
        ...
        expResult = "HEAD < (None)<-[1]->(2) (1)<-[2]->(3) (2)<-[3]->(4) (3)<-[4]->(None) > TAIL"
        result = str(self.A)
        self.assertEqual(result, expResult)
        print("\ntestAppend PASSED!")
    ...
    def testUpdateIndex(self):
        ...
        expResult = "HEAD < (None)<-[4]->(2) (4)<-[2]->(3) (2)<-[3]->(None) > TAIL"
        result = str(self.A)
        ...
        expResult = "HEAD < (None)<-[4]->(5) (4)<-[5]->(3) (5)<-[3]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
        ...
        expResult = "HEAD < (None)<-[4]->(5) (4)<-[5]->(6) (5)<-[6]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
    ...
    def testDeleteIndex(self):
        ...
        expResult = "HEAD < (None)<-[1]->(2) (1)<-[2]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
        ...
        expResult = "HEAD < (None)<-[2]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
    ...
    def testInsertBeforeIndex(self):
        ...
        expResult = "HEAD < (None)<-[4]->(1) (4)<-[1]->(2) (1)<-[2]->(3) (2)<-[3]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
        ...
        expResult = "HEAD < (None)<-[4]->(1) (4)<-[1]->(2) (1)<-[2]->(5) (2)<-[5]->(3) (5)<-[3]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
        ...
        expResult = "HEAD < (None)<-[4]->(1) (4)<-[1]->(2) (1)<-[2]->(5) (2)<-[5]->(3) (5)<-[3]->(6) (3)<-[6]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
    ...
    def testDeleteAllData(self):
        ...
        expResult = "HEAD < (None)<-[2]->(3) (2)<-[3]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
    ...
    def testInsertAfterEveryData(self):
        ...
        expResult = "HEAD < (None)<-[1]->(4) (1)<-[4]->(2) (4)<-[2]->(3) (2)<-[3]->(1) (3)<-[1]->(4) (1)<-[4]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
    ...
    def testInsertBeforeEveryData(self):
        ...
        expResult = "HEAD < (None)<-[4]->(1) (4)<-[1]->(2) (1)<-[2]->(3) (2)<-[3]->(4) (3)<-[4]->(1) (4)<-[1]->(None) > TAIL"
        result = str(self.A)
        self.assertTrue(boolResult)
        self.assertEqual(result, expResult)
